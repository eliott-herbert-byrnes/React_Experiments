...
const BentoTilt = ({ children, className = '' }) => {
    ...
    const handleMouseMove = (e) => {
        ...
        const relativeX = (e.client - left) / width
        const relativeY = (e.client - top) / height
        ...
        <div className="relative size-full">
            ...
            <div className="relative z-10 flex-size-full flex-col justify-between p-5 text-blue-50">
                <div className="">
                    ...
                    {description && <p className='mt-3 max-w-63 text-sm md:text-base'>{description}</p>}
                </div>
        ...
        <section className='bg-black pb-52'>
            <div className="container mx-auto px-3 md:px-10">
                <div className="px-5 py-32">
                    ...
                    <BentoTilt className="border-hsla relative mt-5 mb-6 h-96 w-full overflow-hidden rounded-md md:h-[65vh]">
                        <BentoCard
                            src='videos/feature-1.mp4'
                            title={<>radi<b>n</b>t</>}
                            description='A cross-platform metagame app, turning your activities across 
                        Web2 and Web3 games into a rewarding adventue.'
                        />
                    </BentoTilt>
                </div>
                <div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-7">
                    ...
                    <BentoTilt className="overflow bento-tilt_1 me-14 md:col-span-1 md:me-0">
                        <BentoCard
                    ...
                    <div className="bento-tilt_2">
                        <div className="flex size-full flex-col justify-between bg-violet-300 p-5">
                            ...
                            <TiLocationArrow className='self-end' />
                        </div>
                    </div>
